...
public class CIHMApp extends JFrame {
    ...
    private JPanel ihmPeriodes = new CIHMGestionPeriodes().getPanneauPrincipal();
    ...
    private String[] position = {"ACCUEIL","PERIODE", "STAGIAIRE", "ENTREPRISE","FORMATEUR"};
    ...
    ****************************************/        
        private JPanel buildMenu(){
          ...
          ****************************************/ 
            JButton btPeriode = new JButton("Périodes");
            btPeriode.addActionListener(new ActionListener(){
    ...
    ****************************************/     
        private JPanel buildConteneur(){  
            ...
            conteneur.add(ihmPeriodes, position[1]);
